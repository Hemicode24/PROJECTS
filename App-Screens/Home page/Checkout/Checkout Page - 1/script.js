...
const additionalOptions = {
    Ramapuram: ['Elite Car Parking', 'Ram Car Parking'],
    Koyambedu: ['Sakthi Car Parking', 'Anitha Car Parking'],
    Velachery: ['hemi Car Parking', 'hema Car Parking'],
...
amountInput1.value = '10 ₹ ';

} else if (hours==1 &&minutes <=60 ) {
amountInput.value = ' 100 ₹';
amountInput1.value = ' 20 ₹  ';
} else {
amountInput.value = ' 150 ₹  ';
amountInput1.value = ' 30 ₹ ';
}
